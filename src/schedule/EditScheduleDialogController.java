...
public class EditScheduleDialogController {
    ...
    private static EditScheduleDialogController instance;

    public EditScheduleDialogController() {
        instance = this;
    }

    public static EditScheduleDialogController getInstance() {
        return instance;
    }
...
//        scheduleItem.setCredits(Integer.parseInt(creditsTextField.getText().trim()));
    ...
    public void handleOKButtonClick(ActionEvent actionEvent) throws IOException {
        ...
        if (!newScheduleItem.isValid()){
            ...
            ScheduleTableController.getInstance().updateScheduleItem(oldScheduleItem, newScheduleItem);
        }
